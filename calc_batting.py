...
BYTE_ARRAY_ARRAY_807B70DC = [[20, 50], [45, 60], [30, 45], [45, 60], [20, 50]]

SHORT_ARRAY_ARRAY_ARRAY_807B708C = [[[-256, 960],[-256, 960],[-256, 960],[-256, 960]], [[-96, 64],[-96, 96],[-96, 64],[-96, 96]], [[-64, 32],[-64, 32],[-64, 32],[-64, 32]], [[-96, 64],[-96, 96],[-96, 64],[-96, 96]], [[-256, 960],[-256, 960],[-256, 960],[-256, 960]]]
...
class BattingCalculator:
    ...
    def calculateBuntingExtras(self):
        ...
        iVar6 = SHORT_ARRAY_ARRAY_ARRAY_807B708C[self.inMemBatter["Batter_ContactType"]][uVar5][0]
        iVar7 = SHORT_ARRAY_ARRAY_ARRAY_807B708C[uVar4][uVar5][1]
        iVar3 = self.inMemBatter["Batter_SlapContactSize"] * (SHORT_ARRAY_ARRAY_ARRAY_807B708C[uVar4][uVar5 + 2][0] - iVar6)
        iVar2 = self.inMemBatter["Batter_SlapContactSize"] * (SHORT_ARRAY_ARRAY_ARRAY_807B708C[uVar4][uVar5 + 2][1] - iVar7)
        ...
        iVar2 = BYTE_ARRAY_ARRAY_807B70DC[self.inMemBatter["Batter_ContactType"]][1] - BYTE_ARRAY_ARRAY_807B70DC[self.inMemBatter["Batter_ContactType"]][0]
        self.Hit_HorizontalPower = (self.StaticRandomInt1 - (self.StaticRandomInt1 / iVar2) * iVar2) + BYTE_ARRAY_ARRAY_807B70DC[self.inMemBatter["Batter_ContactType"]][0]
